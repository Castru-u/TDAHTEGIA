...
<body>
    <?php require_once '../../app/pages/cabecalho.php'; ?>
    ...
    <main class="container">
        ...
        <form class="formulario" action="crud_processar.php" method="POST" enctype="multipart/form-data">
        ...
        <form class="formulario" action="crud_processar.php" method="POST">
            ...
            <tbody>
                <?php foreach ($usuarios as $usuario): ?>
                    <tr>
                        ...
                        <td>
                        <a href="deletar.php?action=remove_user&idcomunidade=<?php echo urlencode($idcomunidade); ?>&idusuario=<?php echo urlencode($usuario['idusuario']); ?>" onclick="return confirm('Tem certeza de que deseja remover este usuário?');">
                            Remover
                        </a>
                        </td>
                    </tr>
