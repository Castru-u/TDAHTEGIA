...
switch ($action) {
    ...
    case 'update':
        ...
        if ($stmt->execute()) {
            header("Location: mostrar_comunidades.php?idcomunidade=$idcomunidade&success=1");
        } else {
            header("Location: mostrar_comunidades.php?idcomunidade=$idcomunidade&error=1");
        }
        $stmt->close();
        break;
    ...
    case 'add_user':
        ...
        if ($stmt->execute()) {
            ...
            header("Location: crud.php?idcomunidade=$idcomunidade&error=1");
        }
        $stmt->close();
        break;
